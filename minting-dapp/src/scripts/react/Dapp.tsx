...
export default class Dapp extends React.Component<Props, State> {
  ...
  {
    try {await this.contract.whitelistMint(amount, Whitelist.getProofForAddress(this.state.userAddress!), {value: this.state.tokenPrice.mul(amount)});
    } catch (e) {
      this.setError(e);
    }
  }
  ...
  private async initWallet(): Promise<void>
  {
    ...
    this.setState({
      maxSupply: (await this.contract.finalMaxSupply()).toNumber(),
